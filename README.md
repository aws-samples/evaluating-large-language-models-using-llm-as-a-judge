**Update** Amazon Bedrock now supports LLM-as-a-judge capabilities - [AWS Blog Post](https://aws.amazon.com/blogs/aws/new-rag-evaluation-and-llm-as-a-judge-capabilities-in-amazon-bedrock/)
